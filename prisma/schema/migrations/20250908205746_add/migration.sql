/*
  ...
  - The values [APPLICATION_SERVICE_PROVIDER,NETWORK_INFRASTRUCTURE,NETWORK_SERVICE_PROVIDER] on the enum `EDocumentType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."EDocumentType_new" AS ENUM ('Business_PLAN', 'RDB_CERTIFICATE', 'COMPANY_CONTRACT');
