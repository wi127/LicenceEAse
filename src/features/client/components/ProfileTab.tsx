    ...
    <div className='px-6 py-4'>
      ...
      <div className='flex space-x-1 mb-6 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg'>
        <button
          ...
          className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 ${activeSubTab === 'personal'
        ...
        <button
          ...
          className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 ${activeSubTab === 'company'
            ? 'bg-white dark:bg-gray-700 text-primary shadow-sm'
            : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200'
            }`}
        >
